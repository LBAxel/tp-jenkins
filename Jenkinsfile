...
DOCKER_ID = "lbaxel" // replace this with your docker-id
            ...
            stage(' Build Cast Image') {
                steps {
                    script {
                        ...
                        docker build -t $DOCKER_ID/$DOCKER_IMAGE_CAST:$DOCKER_TAG ./Config/cast-service
                        sleep 6
                        '''
                    }
                }
            ...
            stage(' Build Movie Image') {
                steps {
                    script {
                        ...
                        docker build -t $DOCKER_ID/$DOCKER_IMAGE_MOVIE:$DOCKER_TAG ./Config/movie-service
                        sleep 6
                        '''
                    }
                }
